...
def test_designs_table_has_required_columns(mock_supa):
    ...
    from apps.api.migrations import DESIGNS_TABLE_SCHEMA
...
def test_evolutions_table_has_design_id_column():
    ...
    from apps.api.migrations import EVOLUTIONS_DESIGN_ID_COLUMN
...
def test_generate_designs_migration_sql():
    ...
    from apps.api.migrations import generate_designs_table_sql
...
def test_generate_evolutions_alter_sql():
    ...
    from apps.api.migrations import generate_evolutions_alter_sql
...
def test_run_migration_executes_sql(mock_supa):
    ...
    from apps.api.migrations import run_migration

    with patch("apps.api.migrations._get_supa", return_value=mock_supa):
